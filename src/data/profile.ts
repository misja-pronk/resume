...
const text = {
  en: {
    ...
    bio: [
      ...
      'With more than a decade in IT — and over 8 years designing and building data solutions — I have grown from data engineer into a well-rounded platform professional: deep expertise on the Databricks platform, metadata-driven data solutions, and the full platform-engineering stack — Terraform, Terragrunt, GitHub, CI/CD and DevOps ways of working. I love open source and prefer open standards over vendor lock-in, both in what I build and in what I share. My recent clients build for a living — construction groups and engineering firms — and data platforms for the built environment have become a specialty.',
      'The part of the job I care most about is upskilling the teams around me — BI teams, software teams, cloud engineers and data scientists alike: pairing, code reviews, setting dbt and Git standards. A platform is only finished when the team runs it without me. I work in short iterations, am not afraid to try something and fail, and happily throw code away to keep things simple.',
    ],
    interests:
