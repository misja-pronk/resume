...
const books: BookDef[] = [
  ...
  { title: 'Ethics of Data and Analytics', author: 'Kirsten Martin', discipline: d.dataEthics, status: 'read' },
  ...
  { title: 'UML 2 and the Unified Process', author: 'Jim Arlow & Ila Neustadt', discipline: d.design, status: 'read' },
  // --- infra & cloud
  { title: 'Terraform in Action', author: 'Scott Winkler', discipline: d.iac, status: 'read' },
  { title: 'HashiCorp Infrastructure Automation Certification Guide', author: 'Ravi Mishra', discipline: d.iac, status: 'read' },
  ...
  { title: 'Implementing Azure Cloud Design Patterns', author: 'Oliver Michalski & Stefano Demiliani', discipline: d.cloud, status: 'read' },
